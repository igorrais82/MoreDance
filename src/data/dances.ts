...
export const dances: Dance[] = [
  {
    ...
    timeSignature: '3/4',
    description:
      'Король бальных танцев. Мягкое кружение в три счёта (28 тактов/мин ≈ 84 BPM) учит держать осанку и двигаться вместе с музыкой.',
  ...
  },
  {
    ...
    timeSignature: '4/4',
    description:
      'Латинский хит с весёлым «ча-ча-ча». Международный счёт 2–3–4&1 при 30 тактах/мин (≈ 120 BPM).',
  ...
  },
  {
    ...
    timeSignature: '4/4',
    description:
      'Самый весёлый танец программы. База на 6 счетов: 1–2, 3a4, 5a6 при 42 тактах/мин (≈ 168 BPM).',
  ...
  },
  {
    ...
    timeSignature: '4/4',
    description:
      'Быстрый стандарт с бегом и лёгкими прыжками. Темп 50 тактов/мин (≈ 200 BPM), шассе часто считают 1–2&3.',
        ...
        steps: [
          {
            count: '1',
            title: 'В сторону',
            instruction: 'Правая вправо (медленный акцент шассе).',
          },
          {
            count: '2',
            title: 'Вместе',
          ...
          },
          {
            ...
            instruction: 'Правая ещё раз вправо на «и».',
          },
          {
            count: '3',
            title: 'Баланс',
      ...
      },
      {
        ...
        steps: [
          ...
          },
          {
            count: '&',
            title: 'Вперёд',
            instruction: 'Правая снова вперёд на «и».',
          },
          {
            count: '3',
            title: 'Собрали',
  ...
  },
  {
    ...
    timeSignature: '2/4',
    description:
      'Бразильский характер: отскок и радость карнавала. Счёт 1-a-2 при 48 тактах/мин (≈ 96 BPM).',
